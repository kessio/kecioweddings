...
(function ($) {
 ...
 var listingid = $("#galeditlisting_id").val();
            // create DOM elements
            var dom = {
                uploaderBox: $(this),
            ...
            function uploadSubmitHandler () {
                if (state.fileBatch.length !== 0) {
                    ...
                    $.ajax({
                        url:'bin/EditGallery.php?listingid'+listingid,
                        type:'POST',
                        data: data,
                        cache: false,
                        contentType: false,
...
(function() {
        ...
        $('.js-uploader__box').uploader({
            ...
            instructionsCopy: 'Upload your files',
            furtherInstructionsCopy: 'drag here or select files',
            selectButtonCopy: 'Select files',
            secondsSelectButtonCpy: 'More upload',
            dropZone: $('html'),
            fileTypeWhiteList: ['jpg', 'png', 'gif'],
            badFileTypeMessage: "sorry,we only accept 'jpg','png','gif',please try again!",
            ajaxUrl: 'bin/EditGallery.php'
        });
    }());